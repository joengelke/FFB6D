...
printf '\n\n##########\n\n'
python3 -m single_ycb_inference -checkpoint $tst_mdl -rgb $base"xtion/rgb/image_rect_color0000.png" -depth $base"xtion/depth_registered/image0000_converted.png" -camera ycb
...
echo -e "\n\n##########\n\n"
python3 -m single_ycb_inference -checkpoint $tst_mdl -rgb $base"/rs/color/image_raw0000.png" -depth $base"/rs/depth/aligned_raw0000_converted.png" -camera intel_l515