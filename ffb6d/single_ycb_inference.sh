...
#printf '\n\n##########\n\n'
python3 -m single_ycb_inference -checkpoint $tst_mdl -rgb $base"xtion/rgb/image_rect_color0000_converted.png" -depth $base"xtion/depth_registered/hw_registered-image_rect0000.png" -camera xtion
#printf "\n\n##########\n\n"
